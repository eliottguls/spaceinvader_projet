...
# Ready - Vous ne pouvez pas voir la balle sur votre écran
# Fire - La balle se déplace
...
print("Pour quitter le jeu il faut stopper le programme sur votre IDE.")

# Boucle durant le jeu
running = True
while running:
    ...
    for event in pygame.event.get():
        ...
        # vérifiez quelle touche est préssée
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_SPACE:
                if bullet_state is "ready":
                    # Récupérez la valeur de x du vaisseau
                    bulletX = playerX
